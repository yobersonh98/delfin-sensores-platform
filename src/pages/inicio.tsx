  ...
  return (
    <div className="flex flex-col min-h-screen dark:bg-muted dark:text-muted-foreground">
      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6 flex flex-col items-center text-center">
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl font-bold tracking-tighter">
                Monitorea tu ambiente con precisión
              </h1>
              <p className="max-w-[700px] text-muted-foreground md:text-xl dark:text-muted-foreground">
                Nuestros sensores de última generación te brindan datos precisos
                sobre la temperatura, humedad, calidad del aire y más. Mantén un
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-primary dark:bg-background">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <Card>
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  ...
                  <ThermometerIcon className="w-4 h-4 text-muted-foreground dark:text-muted-foreground" />
                </CardHeader>
                <CardContent>
                  <div className="text-4xl font-bold">24°C</div>
                  <p className="text-xs text-muted-foreground dark:text-muted-foreground">
                    +2.1% desde la última hora
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  ...
                  <DropletIcon className="w-4 h-4 text-muted-foreground dark:text-muted-foreground" />
                </CardHeader>
                <CardContent>
                  <div className="text-4xl font-bold">65%</div>
                  <p className="text-xs text-muted-foreground dark:text-muted-foreground">
                    +1.8% desde la última hora
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  ...
                  <AirVentIcon className="w-4 h-4 text-muted-foreground dark:text-muted-foreground" />
                </CardHeader>
                <CardContent>
                  <div className="text-4xl font-bold">Buena</div>
                  <p className="text-xs text-muted-foreground dark:text-muted-foreground">
                    Partículas en niveles seguros
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  ...
                  <SunIcon className="w-4 h-4 text-muted-foreground dark:text-muted-foreground" />
                </CardHeader>
                <CardContent>
                  <div className="text-4xl font-bold">1200 lux</div>
                  <p className="text-xs text-muted-foreground dark:text-muted-foreground">
                    +120 lux desde la última hora
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  <CardTitle className="text-sm font-medium">Ruido</CardTitle>
                  <VolumeIcon className="w-4 h-4 text-muted-foreground dark:text-muted-foreground" />
                </CardHeader>
                <CardContent>
                  <div className="text-4xl font-bold">45 dB</div>
                  <p className="text-xs text-muted-foreground dark:text-muted-foreground">
                    -2 dB desde la última hora
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  ...
                  <MicroscopeIcon className="w-4 h-4 text-muted-foreground dark:text-muted-foreground" />
                </CardHeader>
                <CardContent>
                  <div className="text-4xl font-bold">450 ppm</div>
                  <p className="text-xs text-muted-foreground dark:text-muted-foreground">
                    -20 ppm desde la última hora
                  </p>
                </CardContent>
              </Card>
            </div>
